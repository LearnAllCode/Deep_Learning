...
# Loss function: how the network will be able to measure its performance
# on the training data, thus how it will be able to steer itself in the right direction
